...
public class GamePlay_UI extends javax.swing.JFrame {

    private final GamePlayManager gamePlayControl;

    public GamePlay_UI(GamePlayManager gamePlayControl) {
        initComponents();
        setResizable(false);
    ...
    public void drawGameTable(int size, int limit) {
        ...
        int col;
        int countRow = 0;
        panelGame.setLayout(new GridLayout(size, size, 10, 10));
    ...
    private void initComponents() {
        ...
        panelGame.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
